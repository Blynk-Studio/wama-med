...
export const cases: PatientCase[] = [
  {
    ...
    stageHistory: [
      { stage: "Nouveau", enteredAt: "Il y a 3 jours", exitedAt: "Il y a 2 jours", duration: "1j", owner: "Salma Rhazi" },
      { stage: "Qualification", enteredAt: "Il y a 2 jours", owner: "Aissatou Faye" },
    ],
    timeline: [
  ...
  },
  {
    ...
    stageHistory: [
      { stage: "Nouveau", enteredAt: "Il y a 5 jours", exitedAt: "Il y a 4 jours", duration: "1j", owner: "Salma Rhazi" },
      { stage: "Qualification", enteredAt: "Il y a 4 jours", exitedAt: "Il y a 2 jours", duration: "2j", owner: "Salma Rhazi" },
      { stage: "Validation", enteredAt: "Il y a 2 jours", owner: "Salma Rhazi" },
    ],
    timeline: [
  ...
  },
  {
    ...
    stageHistory: [
      { stage: "Nouveau", enteredAt: "Il y a 10 jours", exitedAt: "Il y a 9 jours", duration: "1j", owner: "Karim Diop" },
      { stage: "Qualification", enteredAt: "Il y a 9 jours", exitedAt: "Il y a 7 jours", duration: "2j", owner: "Karim Diop" },
      { stage: "Validation", enteredAt: "Il y a 7 jours", exitedAt: "Il y a 3 jours", duration: "4j", owner: "Karim Diop" },
      { stage: "Planification", enteredAt: "Il y a 3 jours", owner: "Karim Diop" },
    ],
    timeline: [
  ...
  },
  {
    ...
    stageHistory: [
      { stage: "Nouveau", enteredAt: "Il y a 14 jours", exitedAt: "Il y a 13 jours", duration: "1j", owner: "Aissatou Faye" },
      { stage: "Qualification", enteredAt: "Il y a 13 jours", exitedAt: "Il y a 11 jours", duration: "2j", owner: "Aissatou Faye" },
      { stage: "Validation", enteredAt: "Il y a 11 jours", exitedAt: "Il y a 8 jours", duration: "3j", owner: "Aissatou Faye" },
      { stage: "Planification", enteredAt: "Il y a 8 jours", exitedAt: "Il y a 2 jours", duration: "6j", owner: "Aissatou Faye" },
      { stage: "Sur place", enteredAt: "Il y a 2 jours", owner: "Aissatou Faye" },
    ],
    timeline: [
  ...
  },
  {
    ...
    stageHistory: [
      { stage: "Nouveau", enteredAt: "Il y a 30 jours", exitedAt: "Il y a 29 jours", duration: "1j", owner: "Nora Ben Salem" },
      { stage: "Qualification", enteredAt: "Il y a 29 jours", exitedAt: "Il y a 27 jours", duration: "2j", owner: "Nora Ben Salem" },
      { stage: "Validation", enteredAt: "Il y a 27 jours", exitedAt: "Il y a 22 jours", duration: "5j", owner: "Nora Ben Salem" },
      { stage: "Planification", enteredAt: "Il y a 22 jours", exitedAt: "Il y a 14 jours", duration: "8j", owner: "Nora Ben Salem" },
      { stage: "Sur place", enteredAt: "Il y a 14 jours", exitedAt: "Il y a 6 jours", duration: "8j", owner: "Nora Ben Salem" },
      { stage: "Cloture", enteredAt: "Il y a 6 jours", owner: "Nora Ben Salem" },
    ],
    timeline: [
  ...
  },
  {
    ...
    stageHistory: [
      { stage: "Nouveau", enteredAt: "Aujourd'hui · 09:55", owner: "Salma Rhazi" },
    ],
    timeline: [
