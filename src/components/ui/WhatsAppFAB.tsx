  ...
  return (
    ...
    >
      <svg viewBox="0 0 24 24" fill="white" width="24" height="24" aria-hidden="true">
        ...
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.554 4.118 1.528 5.847L0 24l6.335-1.652A11.954 11.954 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.818 9.818 0 01-5.007-1.375l-.36-.214-3.727.978.993-3.63-.233-.374A9.818 9.818 0 012.182 12C2.182 6.578 6.578 2.182 12 2.182c5.423 0 9.818 4.396 9.818 9.818 0 5.423-4.395 9.818-9.818 9.818z" />
      </svg>
    </a>
  );
}
